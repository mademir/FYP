...
public class PlayerController : MonoBehaviour
{
    ...
    internal bool isInteractKeyPressed = false;

    float horizontalInput;
    float verticalInput;
    float horizontalRotationInput;
    float mouseY;
...
//#endif
    ...
    void Update()
    {
        ...
        isInteractKeyPressed = Input.GetKeyDown(KeyCode.E);
        ...
        horizontalRotationInput = Input.GetAxis("Mouse X") * sensitivity;
